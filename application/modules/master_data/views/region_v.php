		...
		<div class="table-responsive mt-3">
			<table class="table table-striped table-hover table-sm table-bordered" id="data_customer">
				...
				<?php
					$i=1;
					$status_txt='';
					foreach ($data_region->result() as $x) {
						...
						<td>
							<div class="btn-group btn-group-sm">
								<a href="#modalView" class="btn btn-primary text-white tooltipnya" title="Lihat detail" data-bs-toggle="modal"
									data-bs-id="<?= $x->id;?>"
									data-bs-kode="<?= $x->kode_region;?>"
									data-bs-nama="<?= $x->nama_region;?>"
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/add_region" method="POST">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/delete_region" method="POST">
	      <div class="modal-body">

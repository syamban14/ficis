	...
	<div class="col bg-info shadow-sm p-3">
		<div class="d-flex align-items-center">
			<span class="text-white">
				<i class="bi bi-receipt"></i>Form Account Payable
			</span>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="createinvoice-tab" data-bs-toggle="tab" data-bs-target="#createinvoice" type="button" role="tab" aria-controls="createinvoice" aria-selected="true">Create AP</button>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" href="<?= base_url();?>create_transaction/account_payable">Close AP</a>
  </li>
</ul>

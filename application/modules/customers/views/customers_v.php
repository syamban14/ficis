			...
			<table id="dataCustomers" class="table table-striped table-hover table-sm" style="width:100%">
		        ...
		        <tbody>
					<?php
						...
						{
							$kodekustomer=$dc->kode_kustomer;
							$wh=$this->Customers_m->warehouse_kustomer($kodekustomer);
							echo'
								<tr>
					...
					<div class="row g-2">
						<div class="col-md-6">
							<div class="form-floating">
								<input type="text" class="form-control text-uppercase" id="cust_name" placeholder="Customer Name">
								<label for="cust_name">Customer Name</label>
							</div>
						</div>
						<div class="col-md-6">  
							<select class="selectpicker form-control h-100 border mod-height-form-floating" data-actions-box="true" data-live-search="true" id="wh_designated" name="wh_designated" data-size="6" data-show-subtext="true" multiple data-selected-text-format="count > 8" required onchange="removeBorder();" title="Pilih Lokasi">
						  		<?php
						...
						<div class="col-md-6">
							<div class="form-floating"> 
								<input type="text" class="form-control text-uppercase" id="customer_code" placeholder="Email" readonly="">
						...
						<div class="col-md-6"> 
								<input type="date" class="form-control" id="due_date" placeholder="Due Date" autocomplete="off">  
						</div>
					</div>
				</div>
		...
		$('#save').click(function(){
			...
			if (cust_name==''){
               ...
               alert('due date harus diisi !!!'); 
				...
				$('#save').append('<div class="spinner-border spinner-border-sm" role="status"><span class="visually-hidden">Loading...</span></div>');

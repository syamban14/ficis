...
<div class="card mt-4 shadow-sm">
	<div class="card-body position-relative">
		...
		<div class="table-responsive mt-3">
			<table class="table table-striped table-hover table-sm table-bordered" id="data_akun_pendapatan">
				<thead>
					<tr>
						<th>No.</th>
						<th>Kode</th>
				...
				<?php
					$i=1;
					$status_txt='';
					foreach ($data_akun_pendapatan->result() as $x) {
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/add_akun_pendapatan" method="POST">
	      <div class="modal-body">
	        <div class="row row-cols-1 g-2">
	        	...
	        	<div class="col" style="min-height:58px;">	
								<select  class="selectpicker form-control h-100 border mod-height-form-floating bg-white shadow-sm" id="project_add" name="project_add" data-live-search="true" data-size="8">
									<option>-Pilih-</option>
									<?php
										foreach ($data_project->result() as $x) {
									?>
										<option value="<?= $x->project_code?>" data-subtext="<?= $x->project_code?>" data-token="<?= $x->project_code?>"><?= $x->project_code?> - <?= $x->project?></option>
									<?php
										}
									?>
								</select>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row row-cols-1 g-2">
        	...
        	<div class="col">
        		<div class="form-floating">
							<input type="text" class="form-control bg-white" id="project" placeholder="Project" readonly>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/edit_akun_pendapatan" method="POST">
	      <div class="modal-body">
	        <div class="row row-cols-1 g-2">
	        	<div class="col">
	        	...
	        	<div class="col">
	        		<div class="form-floating">
						<select  class="form-control bg-white" id="project_edit"  name="project_edit" placeholder="Project">
							<?php
								foreach ($data_project->result() as $x) {
							?>
								<option value="<?= $x->project_code?>" data-subtext="<?= $x->project_code?>" data-token="<?= $x->project_code?>"><?= $x->project_code?> - <?= $x->project?></option>
						...
						<label for="project_edit">Project</label>
					</div>
	        	</div>
	        </div>
	      </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/delete_akun_pendapatan" method="POST">
	      <div class="modal-body">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#data_akun_pendapatan').DataTable();
	...
	modalView.addEventListener('show.bs.modal', function (event) {
	  ...
	  var projectInput = modalView.querySelector('.modal-body input#project')
	...
	modalEdit.addEventListener('show.bs.modal', function (event) {
	  ...
	  var statusSwitch = modalEdit.querySelector('.modal-body input#status_edit')
		document.getElementById("project_edit").value = project;

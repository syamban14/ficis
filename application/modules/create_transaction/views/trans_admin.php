...
<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 d-flex justify-content-center non-staff-home">
	...
	<div class="col text-center bg-white border p-4 py-5 position-relative overflow-hidden boxnya">
		...
		<div class="back-layer">
			...
			<div class="d-flex justify-content-center">
				<a href="<?= base_url();?>create_transaction/form_account_payable" class="btn btn-outline-primary">Account Payable</a>
				<a href="<?= base_url();?>create_transaction/account_payable" class="btn btn-outline-primary">Close Account Payable</a>
			</div>
		</div>

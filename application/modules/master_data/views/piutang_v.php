...
<div class="card mt-4 shadow-sm">
	<div class="card-body position-relative">
		...
		<div class="table-responsive mt-3">
			<table class="table table-striped table-hover table-sm table-bordered" id="data_akun_piutang">
				<thead>
					<tr>
						<th>No.</th>
						<th>Kode</th>
				...
				<?php
					$i=1;
					$status_txt='';
					foreach ($data_akun_piutang->result() as $x) {
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/add_akun_piutang" method="POST">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/edit_akun_piutang" method="POST">
	      <div class="modal-body">
	        <div class="row row-cols-1 g-2">
	        	<div class="col">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     	...
     	<form action="<?php echo base_url();?>master_data/delete_akun_piutang" method="POST">
	      <div class="modal-body">

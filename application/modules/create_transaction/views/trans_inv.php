						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
								<table id="dataAkunPendapatan<?= $mdl; ?>" class="table table-hover table-sm" style="width: 100%;">
									...
									<tbody>
										<?php $no = 0;
										foreach ($data_akun_pendapatan->result_array() as $x): $no++ ?>
											<tr>
						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
								<table id="dataAkunPiutang<?= $mdl; ?>" class="table table-hover table-sm" style="width: 100%;">
									...
									<tbody>
										<?php $no = 0;
										foreach ($data_akun_piutang->result_array() as $x): $no++ ?>
											<tr>
												<td class="d-none"><?= $no; ?></td>
												<td><?= $x['id']; ?></td>
												<td><?= $x['kode_akun']; ?></td>
						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
								<table id="dataSatuan<?= $mdl; ?>" class="table table-hover table-sm" style="width: 100%;">
									...
									<tbody>
										<?php $no = 0;
										foreach ($data_satuan->result_array() as $x): $no++ ?>
											<tr>
												<td class="d-none"><?= $no; ?></td>
												<td><?= $x['satuan']; ?></td>
						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
								<table id="dataPajak<?= $mdl; ?>" class="table table-hover table-sm" style="width: 100%;">
									...
									<tbody>
										<?php $no = 0;
										foreach ($data_pajak->result_array() as $x): $no++ ?>
											<tr>
												<td class="d-none"><?= $no; ?></td>
												<td><?= $x['id']; ?></td>
												<td><?= $x['kode_pajak']; ?></td>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		function formatAngkaInput(inputElement) {
			...
			const hasilPemformatan = parseFloat(angka).toLocaleString('en-US', {
				maximumFractionDigits: 2
			}); // Ganti dengan 'id-ID' jika ingin format Indonesia
							...
							if (no_inv != '' && deskripsi != '' && department != 'Pilih Department' && project != 'Pilih Project' && id_akunPendapatan != '' && id_akunPiutang != '' && satuan != '' && no_jumlah != '' && no_harga != '' && (no_total != '' || no_total != '0') && id_pajak != '' && no_netto != '') {
								$.ajax({
									...
									data: {
										...
										project: project,
										id_akunPendapatan: id_akunPendapatan,
										id_akunPiutang: id_akunPiutang,
										no_jumlah: no_jumlah,
										satuan: satuan,
										no_harga: no_harga.replace(/,/g, ""),
										no_total: no_total,
										id_pajak: id_pajak,
										no_netto: no_netto
									},

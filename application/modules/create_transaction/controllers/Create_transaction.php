<?php
	...
	class Create_transaction extends MX_Controller{
		...
		{
			$x['data_invoice_penjualan']=$this->Create_transaction_m->getDataInvoice_ar();
			$x['data_akun_setting'] = $this->Create_transaction_m->getDataAkunSetting();
			$x['data_bank'] = $this->Create_transaction_m->getDataBank2();
		...
		public function close_invoice()
		{
			...
			$this->Create_transaction_m->close_invoice($no_inv,$akun_bank,$akun_pph,$akun_ppn,$akun_adminbank,$akun_bungafactoring,$saldoawal,$bank,$pph,$ppn,$adminbank,$bungafactoring,$saldoakhir);
			echo 1;
		}
